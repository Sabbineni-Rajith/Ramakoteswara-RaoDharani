...
import { Calendar, MapPin, Clock, Heart, Camera, ArrowRight, X, ChevronLeft, ChevronRight, Star, Upload, Save, Trash2, Music, Pause, Play } from "lucide-react";
...
export default function App() {
  ...
  // Editable State
  const [groomName, setGroomName] = useState(() => localStorage.getItem("groomName") || "Ramakoteswara");
  const [groomLastName, setGroomLastName] = useState(() => localStorage.getItem("groomLastName") || "Rao");
  const [brideName, setBrideName] = useState(() => localStorage.getItem("brideName") || "Dharani");
  const [weddingDate, setWeddingDate] = useState(() => localStorage.getItem("weddingDate") || "2026-04-03");
  const [weddingTime, setWeddingTime] = useState(() => localStorage.getItem("weddingTime") || "09:47 PM");
  const [weddingVenue, setWeddingVenue] = useState(() => localStorage.getItem("weddingVenue") || "Peddapulivarru");
  const [weddingAddress, setWeddingAddress] = useState(() => localStorage.getItem("weddingAddress") || "6-91/A, Near Repalle, Andhra Pradesh");
  const [mapUrl, setMapUrl] = useState(() => localStorage.getItem("mapUrl") || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3835.405544747447!2d80.8224!3d16.0374!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTbCsDAyJzE0LjYiTiA4MMKwNDknMjAuNiJF!5e0!3m2!1sen!2sin!4v1711480000000!5m2!1sen!2sin");
  const [musicUrl, setMusicUrl] = useState(() => localStorage.getItem("musicUrl") || "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3");
  ...
  const [galleryImages, setGalleryImages] = useState(() => {
    ...
    return saved ? JSON.parse(saved) : [
      { src: "https://picsum.photos/seed/wedding_vibrant1/1200/1600", title: "The Beginning", size: "large" },
      { src: "https://picsum.photos/seed/wedding_vibrant2/1200/1200", title: "Shared Dreams", size: "small" },
      { src: "https://picsum.photos/seed/wedding_vibrant3/1600/1200", title: "Quiet Moments", size: "wide" },
      { src: "https://picsum.photos/seed/wedding_vibrant4/1200/1600", title: "Endless Love", size: "large" },
      { src: "https://picsum.photos/seed/wedding_vibrant5/1200/1200", title: "The Promise", size: "small" },
      { src: "https://picsum.photos/seed/wedding_vibrant6/1600/1200", title: "Celebration", size: "wide" },
    ];
  });
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (file.size > 2 * 1024 * 1024) {
        alert("Image is too large! Please upload images smaller than 2MB.");
        return;
      }
      ...
      reader.onloadend = () => {
        ...
        safeSetLocalStorage("galleryImages", JSON.stringify(updated));
      };
  ...
  const deleteImage = (index: number) => {
    const updated = galleryImages.filter((_: any, i: number) => i !== index);
    setGalleryImages(updated);
    safeSetLocalStorage("galleryImages", JSON.stringify(updated));
  };
  ...
  const saveSettings = () => {
    const success = [
      safeSetLocalStorage("groomName", groomName),
      safeSetLocalStorage("groomLastName", groomLastName),
      safeSetLocalStorage("brideName", brideName),
      safeSetLocalStorage("weddingDate", weddingDate),
      safeSetLocalStorage("weddingTime", weddingTime),
      safeSetLocalStorage("weddingVenue", weddingVenue),
      safeSetLocalStorage("weddingAddress", weddingAddress),
      safeSetLocalStorage("mapUrl", mapUrl),
      safeSetLocalStorage("musicUrl", musicUrl)
    ].every(Boolean);
  ...
  const handleMusicUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (file.size > 3 * 1024 * 1024) {
        alert("Music file is too large! Please upload files smaller than 3MB or use a direct URL.");
        return;
      }
      const reader = new FileReader();
      reader.onloadend = () => {
        ...
        setMusicUrl(base64);
        safeSetLocalStorage("musicUrl", base64);
      };
      reader.readAsDataURL(file);
    }
  };
              ...
              {!isAuthorized ? (
                ...
                <div className="space-y-12">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="flex items-center space-x-2 text-[#e2c28a] text-sm" onClick={saveSettings}>
                      <Save size={16} /> <span>Save All Settings</span>
                    </button>
                  </div>
